...
namespace PuruSignals
{
    ...
    [AddComponentMenu("PSS/Standalone Utilities/FX/PSS_CameraLayerIsolationZone [Utility]")]
    [PSS_Note("Zone-based camera layer isolation. Strips remote players and/or nameplates from ScreenCamera.CullingMask while local player is inside the trigger. Restores on exit or respawn. Requires VRChat SDK 3.9+.")]
    public class PSS_CameraLayerIsolationZone : UdonSharpBehaviour
    {
        [Header("Mode")]
