...
namespace PuruSignals
{
    ...
    [AddComponentMenu("PSS/Standalone Utilities/FX/PSS_CameraLayerIsolation [Utility]")]
    [PSS_Note("Globally strips selected layers from ScreenCamera.CullingMask. Toggle remote players and nameplates independently. Enable()/Disable() for external control. Requires VRChat SDK 3.9+.")]
    public class PSS_CameraLayerIsolation : UdonSharpBehaviour
    {
        [Header("Mode")]
